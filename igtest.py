...
# Assuming your images are in the same directory as the script
image_paths = [
    "ig.jpg",
    "ig2.jpg",
    "ig3.jpg"
...
new_input = response.choices[0].message.content
#print(new_input)
...
# Print the travel recommendations
print("\nTravel Recommendations:")
print(recommendation_response.choices[0].message.content)
